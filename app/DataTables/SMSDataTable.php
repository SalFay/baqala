...
class SMSDataTable extends DataTable
{
  ...
  public function dataTable( $query )
  {
    return datatables()
      ...
      ->editColumn( 'properties', function( $row ) {
        ...
        if( $row->log_name === 'not-send-sms-manual' || $row->log_name === 'not-send-sms' ) {
  ...
  public function query( Activity $model )
  {
    ...
    $array = [ 'send-sms-manual', 'not-send-sms-manual', 'registered-sms', 'send-sms' ];
    $query->whereIn( 'log_name', $array );
  ...
  protected function getColumns()
  {
    return [
      ...
      Column::make( 'properties' )->title( 'Number' ),
