...
!function (e, t) {'object' == typeof exports && 'undefined' != typeof module ? t(exports, require('jquery')) : 'function' == typeof define && define.amd ? define(['exports', 'jquery'], t) : t((e = 'undefined' != typeof globalThis ? globalThis : e || self).adminlte = {}, e.jQuery)}(this, (function (e, t) {
	...
	var n = a(t), i = 'CardRefresh', o = 'lte.cardrefresh', l = n.default.fn[i], s = 'card',
	 r = '[data-card-widget="card-refresh"]', d = {
		 ...
		 onLoadDone: function (e) {return e},
	...
	var de = 'lte.iframe', fe = n.default.fn.IFrame, ue = '[data-widget="iframe"]',
	 ...
	 je = 'iframe-mode-fullscreen', ke = {
		 ...
		 return t.onTabClick = function (e) {this._config.onTabClick(e)}, t.onTabChanged = function (e) {this._config.onTabChanged(e)}, t.onTabCreated = function (e) {this._config.onTabCreated(e)}, t.createTab = function (e, t, a, i) {
			 ...
			 var e = this
			 n.default(window).on('resize', (function () {setTimeout((function () {e._fixHeight()}), 1)})), n.default(he).hasClass(Se) && (n.default(document).on('click', xe + ', .sidebar-search-results .list-group-item', (function (t) {t.preventDefault(), e.openTabSidebar(t.target)})), this._config.useNavbarItems && n.default(document).on('click', Ie + ', ' + Te, (function (t) {t.preventDefault(), e.openTabSidebar(t.target)}))), n.default(document).on('click', _e, (function (t) {t.preventDefault(), e.onTabClick(t.target), e.switchTab(t.target)})), n.default(document).on('click', _e, (function (t) {t.preventDefault(), e.onTabClick(t.target), e.switchTab(t.target)})), n.default(document).on('click', '[data-widget="iframe-close"]', (function (t) {
				 t.preventDefault()
				 var a = t.target
	...
	var He = 'lte.layout', ze = n.default.fn.Layout, Fe = '.main-header', Ee = '.main-sidebar',
	 Le = '.main-sidebar .sidebar', De = '.main-footer', Re = 'sidebar-focused', Ae = {
		 ...
		 }, t._isFooterFixed = function () {return 'fixed' === n.default(De).css('position')}, e._jQueryInterface = function (t) {
	...
	var Qt = 'TodoList', Ht = 'lte.todolist', zt = n.default.fn[Qt], Ft = 'done',
	 Et = { onCheck: function (e) {return e}, onUnCheck: function (e) {return e} }, Lt = function () {
		 function e (e, t) {this._config = t, this._element = e, this._init()}
