...
export default function InventoryPage() {
  ...
  const [movementFilters, setMovementFilters] = useState({ page: 1, per_page: 20 });
      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        ...
        <Col span={6}>
          <Card>
            <Statistic
              title="Out of Stock"
              value={lowStockData?.filter((i) => i.available_quantity <= 0).length || 0}
          ...
          <Form form={form} layout="vertical" onFinish={handleAdjust}>
            ...
            <Form.Item
              ...
              rules={[
                ...
                ...(adjustType === 'remove'
                  ? [{ type: 'number', max: selectedItem.quantity, message: `Cannot remove more than ${selectedItem.quantity}` }]
                  : []),
              ]}
            >
              <InputNumber
