...
export default function ReturnsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'total_amount',
      render: (val) => `${val?.toFixed(2) || '0.00'} SAR`,
    },
    {
      title: 'Date',
  ...
  const handleCreateReturn = (values) => {
      ...
      >
        {!selectedOrder ? (
          ...
          <Form form={form} layout="vertical" onFinish={handleCreateReturn}>
            ...
            <Form.List name="items" initialValue={returnableItems?.items?.map((item) => ({
          ...
          <>
            ...
            <Table
              ...
              columns={[
                ...
                { title: 'Unit Price', dataIndex: 'unit_price', key: 'price', render: (v) => `${v?.toFixed(2)} SAR` },
