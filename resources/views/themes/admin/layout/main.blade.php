...
<head>
	...
	<link rel="icon" href="{{asset('themes/admin/images/favicon/1.png')}}" type="image/x-icon">
	<link rel="shortcut icon" href="{{asset('themes/admin/images/favicon/1.png')}}" type="image/x-icon">
...
<div class="page-wrapper">
				...
				<div class="logo-wrapper">
					<a href="index.html">
						<img class="blur-up lazyloaded d-block d-lg-none"
						     src="{{asset('themes/admin/images/dashboard/multikart-logo-black.png')}}" alt="">
					</a>
				</div>
			</div>
					...
					<li class="onhover-dropdown">
						<div class="media align-items-center">
							<img class="align-self-center pull-right img-50 blur-up lazyloaded"
							     src="{{asset('themes/admin/images/dashboard/user3.jpg')}}" alt="header-user">
	...
	<div class="page-body-wrapper">
		@include('themes.admin.layout.menu')
