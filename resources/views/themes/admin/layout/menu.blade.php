...
<div class="page-sidebar">
		...
		<div class="logo-wrapper">
			<a href="index.html">
				<img class="d-none d-lg-block blur-up lazyloaded"
				     src="{{asset('themes/admin/images/dashboard/multikart-logo.png')}}" alt="">
			</a>
		</div>
	</div>
	<div class="sidebar custom-scrollbar">
		...
		<div class="sidebar-user">
			<img class="img-60" src="{{asset('themes/admin/images/dashboard/user3.jpg')}}" alt="#">
			<div>
			...
			<div class="chat-box">
				<div class="people-list friend-list">
					<ul class="list">
						...
						<li class="clearfix">
							<img class="rounded-circle user-image blur-up lazyloaded"
							     src="{{asset('themes/admin/images/dashboard/user5.jpg')}}" alt="">
							<div class="status-circle away"></div>
							<div class="about">
