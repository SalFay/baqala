<div class="card border-dark">
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                ...
                <select name="printer" id="printer" data-placeholder="Select Printer" class="form-control"
                        data-module="select2">
                    <option value="Thermal Arabic New" <?php echo $printer === 'Thermal Arabic New'?' selected':''; ?>>Thermal
                        Arabic New
                    </option>
                    <option value="Thermal Eng" <?php echo $printer === 'Thermal Eng'?' selected':''; ?>>Thermal English
                    </option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" name="customer_name" value="<?php echo e($customer->full_name ?? ' '); ?>" id="customer_name"
                       required
                       class="form-control"/>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="date" name="date" value="<?php echo e(date('Y-m-d')); ?>" id="date" required class="form-control"/>
            </div>
        </div>
        <div class="form-group row">
...
<?php /**PATH C:\laragon\www\pos\themes/admin/order/payment.blade.php ENDPATH**/ ?>