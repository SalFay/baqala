...
<?php $__env->startSection('page-title','Sale'); ?>
<?php $__env->startSection('heading','Sale'); ?>
<?php $__env->startSection('breadcrumbs', 'Sale'); ?>
    ...
    <form method="post" action="#" name="form-cart" id="form-cart" class="form-horizontal">
        ...
        <div id="tables">
            <div class="form-group row">
                <input type="hidden" name="customer_id" value="Walking Customer" id="customer" readonly
                       class="form-control"/>

                <div class="col-md-6">
                    <?php echo $__env->make('admin.pos.products', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <?php echo $__env->make('admin.order.payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
        <input type="hidden" id="cart_url" value="<?php echo e(route('order.show_cart',1)); ?>">
    </form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('plugins.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('plugins.DataTables', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('plugins.select2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('footer'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#payments').select2({
                ajax: {
                    url: "<?php echo e(route('select2.banks')); ?>",
                    type: 'post',
            ...
            $('#products').select2({
                ajax: {
                    url: "<?php echo e(route('select2.products')); ?>",
                    type: 'post',
                    data: function (params) {
                        return {
                            term: params.term
        ...
        ui.$body.on('click', '[data-action="addCart"]', function (e) {
            ...
            let url = '<?php echo e(route("order.add_to_cart", 1)); ?>'
            $.ajax({
                url: url,
                type: 'post',
                dataType: 'json',
        ...
        ui.$body.on('click', '[data-action="emptyCart"]', function (e) {
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        $.ajax({
                            url: '<?php echo e(route('order.empty_cart', 1)); ?>',
                            type: 'post',
                            dataType: 'json',
                            success: function (res) {
                                if (res.status === 'ok') {
        ...
        function proceed() {
            ...
            //let vat = '<?php echo e(option('vat_amount')); ?>'
        ...
        function deleteRow(id) {
            $.confirm({
                ...
                buttons: {
                    confirm: function () {
                        $.ajax({
                            url: '<?php echo e(route('order.delete_from_cart', 1)); ?>',
                            type: 'post',
                            dataType: 'json',
                            data: {
                                'id': id
                ...
                buttons: {
                    confirm: function () {
                        ...
                        if (products.length > 0) {
                            $.ajax({
                                url: '<?php echo e(route('order.add',1)); ?>',
                                type: 'post',
                                dataType: 'json',
                                data: {
                                    products: products,
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pos\themes/admin/pos/index.blade.php ENDPATH**/ ?>