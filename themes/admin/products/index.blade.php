            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.product_image) {
                        // If the product has an image, set it to an image preview (for example, a thumbnail)
                        $('#product_image_preview').attr('src', res.product_image).show();
                    } else {
                        // If no image is available, hide the preview image
