<div class="card">
	<div class="card-header bg-transparent header-elements-inline">
		<h6 class="card-title">Stock Invoice</h6>
	...
	<div class="card-body">
		<div class="row">
			<div class="col-sm-6">
				<div class="mb-4">
					<img src="{{asset('assets/emp-logo.png')}}" class="mb-3 mt-2" alt="" style="width: 120px;">
		...
		<div class="d-md-flex flex-md-wrap">
			...
			<div class="pt-2 mb-3 wmin-md-400 ml-auto">
				...
				<div class="text-right mt-3">
					<button type="button" class="btn btn-primary btn-labeled btn-labeled-left"><b><i class="icon-paperplane"></i></b>
						Send invoice
					</button>
				</div>
			</div>
